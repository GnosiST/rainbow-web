...
- [x] 1. 扩展内容系统支持 featured
  - [x] 1.1 更新示例项目
    - 为部分项目添加 featured: true
    - _Requirements: 1.1_
  - [x] 1.2 更新 build-index 脚本
    - 生成 featured 项目列表
    - _Requirements: 1.2_

- [x] 2. 实现 Slideshow Window
  - [x] 2.1 创建基础结构
    - 读取 featured 项目列表
    - 管理当前索引状态
    - _Requirements: 1.3_
...
- [x] 6. 集成到 WindowFrame
  - [x] 6.1 更新 WindowContent
    - 添加 slideshow 和 photos 类型处理
    - _Requirements: 1.3_

- [x] 7. Checkpoint - Slideshow & Photos 验收
  - 确保 Slideshow 可连续浏览
